...
const App = () => (
  <div>
    <Navbar />
    <Jumbotron phrase="From Analytics to Code." subtitle="The story of my transition from the Pentagon to software development" />
    <h3>My Story</h3>
    <hr />
    <div className="row">
      <div className="col-md-6 aboutSections">
        <img className="profilePic profilePic1" src="../static/pics/0.jpg" alt="profilepic" />
      </div>
      <div className="col-md-6 aboutSections">
